...
## label, highlight에서의 강조색.
define gui.accent_color = '#ff4444' #changed

## 마우스가 올려지지 않은 상태의 idle color.
define gui.idle_color = '#f2f2f2' #changed
...
## 인게임 폰트 (Main, 텍스트)
define gui.text_font = "font/NanumGothicBold.ttf"

## 캐릭터 이름 폰트
define gui.name_text_font = "font/GodoM.ttf"

## 게임 외부 폰트 (out of Main)
define gui.interface_text_font = "font/NanumGothicBold.ttf"
...
## game's UI label 텍스트 크기
define gui.label_text_size = 31

## notify screen 텍스트 크기
define gui.notify_text_size = 16

## 게임 타이틀 크기 (only if 텍스트 타이틀)
...
## 대화창의 수평 위치. 실제 위치를 사용하거나 1.0에 대한 비율로 사용할 수 있음.
